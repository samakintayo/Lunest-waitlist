    ...
    <div className="w-full min-h-screen bg-white overflow-hidden flex flex-col items-center justify-center px-4 py-10 lg:py-4 relative">
      <div className="w-full mx-auto px-6 flex flex-wrap justify-evenly items-start flex-wrap content-start gap-10">
        <Cards
          ...
          imgSrc="./src/assets/lunest-verified.svg"
        ...
        <Cards
          ...
          imgSrc="./src/assets/lunest-secure-platform.svg"
        ...
        <Cards
          ...
          imgSrc="./src/assets/lunest-early-access.svg"
        ...
        <Cards
          bgColor="bg-sky-100"
          imgSrc="./src/assets/lunest-flexible-rental.svg"
        ...
        <Cards
          ...
          imgSrc="./src/assets/lunest-easy-to-use.svg"
        ...
        <Cards
          ...
          imgSrc="./src/assets/lunest-real-reviews.svg"
